...
const StudentSubjects = () => {
                        ...
                        {subjectMarks.map((result, index) => {
                            ...
                            return (
                                <StyledTableRow key={index}>
                                    ...
                                    <StyledTableCell>{firstCA}</StyledTableCell>
                                    <StyledTableCell>{secondCA}</StyledTableCell>
                                    <StyledTableCell>{thirdCA}</StyledTableCell>
                                    <StyledTableCell>{test}</StyledTableCell>
                                    <StyledTableCell>{exam}</StyledTableCell>
                                    <StyledTableCell>{total}</StyledTableCell>
                                </StyledTableRow>
    ...
    const renderChartSection = () => {
        // Chart will use total marks for each subject
        ...
        return <CustomBarChart chartData={chartData} dataKey="total" />;
    };
